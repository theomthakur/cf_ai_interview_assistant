...
// .wrangler/tmp/bundle-CU0RLT/checked-fetch.js
...
// src/ai-handler.ts
async function handleAIRequest(AI, params) {
  const { message, context } = params;
  const systemPrompt = `You are an expert technical interviewer conducting a ${context} interview. 
  Your role is to:
  1. Ask relevant technical questions
  2. Provide constructive feedback
  3. Guide the candidate through problems
  4. Evaluate responses fairly
  5. Offer hints when the candidate is stuck
  
  Be professional, encouraging, and maintain a realistic interview atmosphere.`;
  try {
    ...
    return {
      text: "I apologize, but I'm having trouble processing your request. Let's continue with the interview.",
      error: true,
      timestamp: (/* @__PURE__ */ new Date()).toISOString()
    };
  }
...
// src/durable-objects/InterviewSession.ts
var InterviewSession = class {
  static {
    __name(this, "InterviewSession");
  }
  state;
  env;
  sessionData = {
...
var app = new Hono2();
app.use("/*", cors({
  origin: ["http://localhost:3000", "http://localhost:3001", "https://your-app.pages.dev"],
...
// ../../../../../../../opt/anaconda3/envs/myenv/lib/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../../../../../../opt/anaconda3/envs/myenv/lib/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-CU0RLT/middleware-insertion-facade.js
...
// ../../../../../../../opt/anaconda3/envs/myenv/lib/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-CU0RLT/middleware-loader.entry.ts
